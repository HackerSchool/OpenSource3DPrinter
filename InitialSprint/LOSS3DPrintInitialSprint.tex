...
\begin{document}
	...
	\textsc{\Large HackerSchool}\\[0.25cm]
        \HRule\\[0.4cm]
        {\LARGE\bfseries Initial Report}\\[0.4cm] % Title of your document
...
\end{titlepage}
	...
	\section{Project specifics}
		...
		\subsection{Task planning and management}
			\subsubsection{Task planning, partial and total ETC}
		...
		\begin{longtable}[H]{||p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}|p{2cm}||}
				\hline
			\textbf{Task} \# & \textbf{Task Description} & \textbf{Main appointed maker(s)} & \textbf{Task Dependencies} & \textbf{Specific needed materials} & \textbf{ETC} & \textbf{ \% of completion to date}\\ \hline
				...
				5 & Assemble Printer (test phase) & Full team & All of the above & N/A & 1-4 days & 0\% \\ \hline

				6 & Flash Marlin firmware into Keyes board (test phase) & Full Team & 0 & None & 1 day & 0 \% \\ \hline
				7 & \textbf{Advanced electrical repairs}:  Repair Power Supply module, possible Keyes board repairs & João and Nuno & 1, 7 & Soldering kit, other specific electrical components & 1-3 weeks & 0 \%  \\ \hline
				
				8* & Mod Marlin firmware, flash moded Marlin & João and Manuel & 7, 6  & N/A & 1-3 weeks & 0\% \\ \hline
				9* & Re-Assemble Printer & Full team & All of the above & N/A & 1-4 days & 0\% \\ \hline
				10* & Rig Octoprint enviroment and setup & Full team & All of the above & Camera & 1 week & 0\% \\ \hline
			

		\end{longtable}
		\end{center}
		\textit{*- The tasks 8, 9 and 10 will be continued in maintenance phase in order to allow Printer upgrades and optimization} \par
